...
| 文章 | 主题 | 链接 |
|---|---|---|
| 01 · 把 SQL 从 2700 次降到 4 次 | 存量报表 N+1 手术：批量 IN + 内存 Map 索引，业务零改动，附可复现 Demo | [掘金](https://juejin.cn/post/7681674195912163328) · [源稿](blog/01-n1-to-batch-report-optimization.md) |
